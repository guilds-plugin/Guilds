...
public final class LeaderboardSorter implements Comparator<Guild> {
    ...
    /**
     * Gets all of the guilds and collects them in a {@link Map} ready for use with
     * {@link OrderComparator#getOrdered()}.
     *
     ...
     * @return a map containing the results in order from highest to lowest, cutting off all results above the
     * limit, if any
     */
