...
public class GuildHandler implements IHandler {
	...
	private void initialize() {
		...
		for (String s : section.getKeys(false)) {
			...
			GuildRole role = new GuildRole(name, level, chat, allyChat, invite, kick, promote, demote, addAlly, removeAlly, changePrefix,
					changeHome, changeMaster, removeGuild, toggleGuild, openVault, transferGuild, activateBuff, upgradeGuild, depositMoney,
					withdrawMoney);
			roles.add(role);
		}
	}
