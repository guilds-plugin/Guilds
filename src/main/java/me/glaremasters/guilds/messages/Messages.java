...
public enum Messages implements MessageKeyProvider {
    ...
    ERROR__ALREADY_IN_GUILD, ERROR__BLACKLIST, ERROR__NO_GUILD, ERROR__ROLE_NO_PERMISSION, ERROR__GUILD_NO_EXIST, ERROR__PLAYER_NOT_FOUND, ERROR__PLAYER_NOT_IN_GUILD, ERROR__NOT_OFFICER,

    BANK__BALANCE,

    ADMIN__DELETE_WARNING, ADMIN__DELETE_SUCCESSFUL, ADMIN__GUILD_VAULT_SIGN,
    ...
    ALLY__NONE, ALLY__LIST, ALLY__DECLINED, ALLY__ACCEPTED,
