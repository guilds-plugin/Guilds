...
public class MySql extends DatabaseProvider {
    ...
    @Override public void createGuild(Guild guild, Callback<Boolean, Exception> callback) {
    ...
    @Override public void removeGuild(Guild guild, Callback<Boolean, Exception> callback) {
    ...
    @Override public void getGuilds(Callback<HashMap<String, Guild>, Exception> callback) {
    ...
    @Override public void updateGuild(Guild guild, Callback<Boolean, Exception> callback) {
        Main.newChain().async(() -> {
    ...
    @Override public void getLeaderboards(Callback<List<Leaderboard>, Exception> callback) {
