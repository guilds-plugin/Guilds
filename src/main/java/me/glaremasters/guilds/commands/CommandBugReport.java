...
public class CommandBugReport extends CommandBase {
	...
	public void execute(Player player, String[] args) {
		...
		player
				.sendMessage(
						ChatColor.GREEN + "Plugin Version: " + ChatColor.GRAY + pdf.getVersion());
		...
		player.sendMessage(ChatColor.GRAY
				+ "When submitting a bug report, please include a screenshot of this information, along with the bug you are reporting. Clicking the"
				+ " following link will take you to the Guild's Information page where you can contact the developer - https://glaremasters"
				+ ".me/support/");
		player.sendMessage(
				ChatColor.AQUA
						+ "Need faster support? Join our discord! https://discord.gg/pDT2ZBS");
	}
}
