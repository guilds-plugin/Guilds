...
public class CommandPromote extends CommandBase {
    ...
    public CommandPromote() {
        super("promote", "Promote a member of your guild", "guilds.command.promote", false,
    ...
    public void execute(Player player, String[] args) {
        ...
        Message.sendMessage(promotedPlayer, Message.COMMAND_PROMOTE_SUCCESSFUL
            .replace("{player}", promotedPlayer.getName(), "{old-rank}", oldRank, "{new-rank}",
                newRank));
        Message.sendMessage(player, Message.COMMAND_PROMOTE_PROMOTED
            .replace("{player}", promotedPlayer.getName(), "{old-rank}", oldRank, "{new-rank}",
                newRank));
